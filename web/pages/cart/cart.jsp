		...
		$(function () {
			...
			$(".updateCount").change(function () {
				...
				if ( confirm("你确定要将【" + name + "】商品修改数量为：" + count + " 吗?") ) {
					//发起请求。给服务器保存修改？？
					location.href = "${sessionScope.basePath}cartServlet?action=updateCount&count="+count+"&id="+id;
				} else {
...
<body>
	...
	<div id="main">
		...
		<C:if test="${not empty sessionScope.cartItems}">
			...
			<div class="cart_info">
				<span class="cart_span">购物车中共有<span class="b_count">${sessionScope.cartItemTotalCount}</span>件商品</span>
				<span class="cart_span">总金额<span class="b_price">${sessionScope.cartItemTotalPrice}</span>元</span>
